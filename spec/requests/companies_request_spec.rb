...
RSpec.describe "Companies", type: :request do
  ...
  describe "POST /companies" do
    ...
    context "request fails" do
      it "returns a 400 status" do
        post "/companies", params: @invlaid_parmas
  ...
  describe "PUT /company/:id" do
    ...
    context "request is successful" do
      it "returns a 200 status" do
        put "/company/#{@company["id"]}", params: @update_params
    ...
    context "request fails(invalid params)" do
      it "returns a 400 status" do
        put "/company/#{@company["id"]}", params: @update_invalid_params
    ...
    context "request fails(invalid id)" do
      it "returns a 404 status" do
        put "/company/#{@company["id"] + 1}", params: @update_params
